...
HD_PWD='D:/Digital_Design/Projects/Project_2/Project Final/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Slave_Single_Port_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_Slave_Single_Port_RAM.tcl
