...
HD_PWD='D:/Digital_Design/Projects/Project_2/Project Final/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Slave_Single_Port_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_Slave_Single_Port_RAM.tcl -notrace
